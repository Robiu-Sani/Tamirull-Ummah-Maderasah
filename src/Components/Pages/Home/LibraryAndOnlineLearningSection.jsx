        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 flex flex-col justify-between">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Our madrasah library houses a comprehensive collection of Islamic
              literature, textbooks, reference books, and journals. Students can
              use these resources to expand their knowledge in both religious
              and academic fields.
            </p>
            ...
            <div className="">
              <button className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition duration-300">
                <AiOutlineFileSearch size={20} className="inline-block mr-2" />
                Explore Library
              </button>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 flex flex-col justify-between">
            ...
            <ul className="list-disc list-inside text-gray-600 mb-4">
              ...
              <li>Live and recorded video lectures from renowned scholars.</li>
